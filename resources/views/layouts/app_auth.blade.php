...
<html>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('{{ asset('dashboard/assets/images/background.png') }}');background-size: cover;"></div>
        ...
        <div class="wrapper-page account-page-full">
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">{{ \Carbon\Carbon::today()->format('Y') }} © Rabeya.lily - Code.com</p>
            </div>
